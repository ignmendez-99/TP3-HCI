...
public class RoutinesAdapterGrid extends RoutinesAdapter {

    public RoutinesAdapterGrid(Context context, List<String> namesList, RoutinesFragment currentFragment) {
